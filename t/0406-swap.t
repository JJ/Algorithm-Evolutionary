...
BEGIN { 
  use_ok( 'Algorithm::Evolutionary::Op::String_Swap' );
};
...
my $sm = new Algorithm::Evolutionary::Op::String_Swap;
isa_ok( $sm, 'Algorithm::Evolutionary::Op::String_Swap' );
...
$sm = new Algorithm::Evolutionary::Op::String_Swap $number_of_chars * $number_of_chars;
isa_ok( $sm, 'Algorithm::Evolutionary::Op::String_Swap' );
...
$sm = new Algorithm::Evolutionary::Op::String_Swap 23;
