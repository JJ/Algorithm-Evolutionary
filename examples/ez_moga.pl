...
=head1 Copyright
  ...
  CVS Info: $Date: 2009/07/23 18:38:15 $ 
  $Header: /media/Backup/Repos/opeal/opeal/Algorithm-Evolutionary/examples/ez_moga.pl,v 1.1 2009/07/23 18:38:15 jmerelo Exp $ 
  $Author: jmerelo $ 
  $Revision: 1.1 $
  $Name $
