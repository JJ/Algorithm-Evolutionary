...
=head1 Copyright
  ...
  CVS Info: $Date: 2009/04/30 07:52:01 $ 
  $Header: /media/Backup/Repos/opeal/opeal/Algorithm-Evolutionary/examples/async/async.pl,v 1.1 2009/04/30 07:52:01 jmerelo Exp $ 
  $Author: jmerelo $ 
  $Revision: 1.1 $
  $Name $
