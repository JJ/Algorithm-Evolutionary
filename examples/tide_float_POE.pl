...
=head1 Copyright
  ...
  CVS Info: $Date: 2008/02/12 20:14:23 $ 
  $Header: /media/Backup/Repos/opeal/opeal/Algorithm-Evolutionary/examples/tide_float_POE.pl,v 1.1 2008/02/12 20:14:23 jmerelo Exp $ 
  $Author: jmerelo $ 
  $Revision: 1.1 $
  $Name $
